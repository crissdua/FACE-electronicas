    ...
    Public Sub EnviaDocumentoInFileSP(ByVal OCompany As SAPbobsCOM.Company, ByVal SBO_Application As SAPbouiCOM.Application, ByVal Tipo As String, ByVal CurrSerie As String, ByVal CurrDoc As String, ByVal CurrSerieName As String, ByVal Pais As String, ByVal DocEntry As String, Optional ByVal ProcesarBatch As Boolean = False)
        ...
        Try
            If Utils.ValidaSerie(OCompany, SBO_Application, CInt(CurrSerie), ProcesarBatch) Then
                ...
                Dim table2 As DataTable = EjecutaSqlTable("CALL " + chr(34) + Company.CompanyDB + Chr(34) + "." + Chr(34) + "SP_FACE_IT_DATOS_ENCABEZADO" + Chr(34) + "('" & DocEntry & "','" & Tipo & "')")
                Dim table As DataTable = EjecutaSqlTable("CALL " + chr(34) + Company.CompanyDB + Chr(34) + "." + Chr(34) + " SP_FACE_IT_DATOS_DETALLE" + Chr(34) + "( '" & DocEntry & "','" & Tipo & "')")
        ...
        Try
            If ValidaSerie(OCompany, SBO_Application, CurrSerie, ProcesarBatch) Then
                ...
                If Tipo = "FAC" Or Tipo = "ND" Then
                    ...
                    obOINV = EjecutaSqlTable("CALL " + chr(34) + Company.CompanyDB + Chr(34) + "." + Chr(34) + "SP_FACE_UTILS" + Chr(34) + "('39','" & DocEntry & "','','','','')")
                Else
                ...
                dte.tipoDocumento = TipoDoc.Rows(0)(0).ToString.Split("-")(0).ToString
                ...
                dte.municipioComprador = TipoMuni.Rows(0)(0).ToString
                ...
                dte.departamentoComprador = TipoDepto.Rows(0)(0).ToString
